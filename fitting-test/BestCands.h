...
namespace CandsGPU 
{
// WARNING: quick and dirty. Matevz said it is sufficient.
// if thesew numbers have to be above 32K, schange to int32_t
using shared_int_t = int16_t; 
...
struct BestCands
{
  ...
  shared_int_t trkIdx [MaxCandsPerSeed][BlockSize];
  shared_int_t hitIdx [MaxCandsPerSeed][BlockSize];
  shared_int_t nhits  [MaxCandsPerSeed][BlockSize];
