...
using PairIntsCU = int2; //PairCU<int, int>;
...
private:
  ...
  // Changing the allocator to pin the memory with: 
  //    thrust::system::cuda::experimental::pinned_allocator<PhiBinInfo_t>
  // makes 
...
public:
  ...
  DeviceVector<cand_idx_t> m_ntracks_per_seed;  // array of m_candidates[i].size()
